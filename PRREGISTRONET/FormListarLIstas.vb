Public Class FormListarListas
    ...
    Private Sub BtnListar_Click(sender As Object, e As EventArgs) Handles BtnListar.Click
        ...
        Dim LISTA1VXX = list.Where(Function(x) Not x.nserie.StartsWith("T26") And Not x.nserie.StartsWith("M26") And (x.nserie.StartsWith("T") Or x.nserie.StartsWith("M"))).ToList()
        ListarListas.Salvar(LISTA1VXX, "LISTA-1VXX")
        PBListarListas.Value = 50

        Dim LISTA2VAA = list.Where(Function(x) x.nserie.StartsWith("TXXAAA")).ToList()
        ListarListas.Salvar(LISTA2VAA, "LISTA-2VAA")
        PBListarListas.Value = 75

        Dim LISTA2VBB = list.Where(Function(x) x.nserie.StartsWith("TXXBBB")).ToList()
